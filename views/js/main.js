...
var pizzaElementGenerator = function(i) {
  ...
  pizzaDescriptionContainer.classList.add("col-sm-12");
  pizzaDescriptionContainer.classList.add("col-xs-12");
...
function changeSliderLabel(size) {
  switch (size) {
    ...
    case "3":
      ...
      return;  
    case "4":
        pizzaSizeElement.innerHTML = "Estra Large";
        return;
    default:
...
var generateItems = function generateItems() {
  var s = 256;
  var pizzaCellHeight = 100;
  var pizzaCellWidth = 73.333;
  var rows = ~~(window.screen.height/pizzaCellHeight);
  var cols = 8;
  ...
  for (var i = 0; i < rows; i++) {
    for (var j = 0; j < cols; j++){
      ...
      elem.style.width = pizzaCellWidth + "px";
